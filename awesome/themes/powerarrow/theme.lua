...
-- local textclock = wibox.widget.textclock ([format=" %a %b %d[, refresh=60[, timezone=local timezone]]])
-- Calendar
...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            --]]
            -- using separators
            arrow(theme.bg_normal,"#D0E17A"),
            wibox.container.background(wibox.container.margin(wibox.widget { nil, capslock, layout = wibox.layout.align.horizontal }, dpi(2), dpi(3)), "#D0E17A"),
            --wibox.container.background(wibox.container.margin(capslock, dpi(4), dpi(8), "#ffffff")),
            arrow("#D0E17A", "#777E76"),
            ...
            arrow("#CB755B", "#71A9C9"),
            wibox.container.background(wibox.container.margin(volume_widget(), dpi(3), dpi(3)), "#71A9C9"),
            arrow("#71A9C9", "#8DAA9A"),
