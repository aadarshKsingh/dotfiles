...
globalkeys = mytable.join(
    ...
    awful.key({ altkey,   }, "h",     function () awful.tag.incnmaster( 1, nil, true) end,
    ...
    awful.key({ ctrlkey, altkey }, "Left", function ()
        ...
        awful.key({ ctrlkey, altkey   }, "Right", function ()
        local c = client.focus
        if awful.layout.get(c.screen).name ~= "treetile" then
            awful.tag.incmwfact(-0.05)
        else
    ...
    awful.key({ ctrlkey, altkey }, "Up", function ()
        local c = client.focus
        if awful.layout.get(c.screen).name ~= "treetile" then
            awful.tag.incmwfact(0.05)
        else
    ...
    awful.key({ ctrlkey, altkey }, "Down", function ()
        local c = client.focus
        if awful.layout.get(c.screen).name ~= "treetile" then
            awful.tag.incmwfact(-0.05)
        else
